  ...
  if (!isAuthenticated) {
    return (
      <div className="d-flex justify-content-center align-items-center vh-100 bg-light text-center">
        <div>
          <h4 className="mb-3 text-danger">برای ارسال درخواست، ابتدا باید وارد شوید</h4>
          <a href="/login" className="btn btn-primary" style={{ backgroundColor: "#002a3a", borderColor: "#002a3a" }}>
            ورود به حساب کاربری
          </a>
        </div>
      </div>
    ...
    <div className="container-fluid py-4">
      <div className="row">
        ...
        <div className="col-lg-6">
          ...
          {requestType === "survey" && <SurveyRequestForm location={location} user={user} />}
          {requestType === "expert" && <ExpertRequestForm location={location} user={user} />}
          {requestType === "deed" && <DeedRegistrationForm location={location} user={user} />}
        </div>
        {/* نقشه سمت چپ */}
