...
class RegistrationRequestAdmin(admin.ModelAdmin):
    ...
    def refer_request(self, request, queryset):
        ...
        content_type = ContentType.objects.get_for_model(RegistrationRequest)
        total_referred = 0
    ...
    def get_actions(self, request):
        ...
        if not request.user.is_superuser and not RegistrationRequest.objects.filter(assigned_admin=request.user).exists():
